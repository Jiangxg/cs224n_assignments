...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        ### Default argument padding = 1 for nn.Conv1d, output and input have different shapes?
